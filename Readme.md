...
#### Adicionado métodos de uso do cofre da GetNet

 Documentação oficial
* https://developers.getnet.com.br/api

Baseado no repositório de: 
* https://github.com/edson-nascimento/getnet-php
...
add composer.json
```
"fhariano/getnet-php": "^1.0"
```
ou execute
```
$ composer require fhariano/getnet-php
```
